...
<head>
  ...
  <title>Ate Carla's Bacsilog | Forgot Password</title>
...
<body>
<form name="test2.php" method = "post" action = "<?php $_PHP_SELF ?>">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-0 col-xs-0 align-items-center py-5">
          <table border="1" width="50%" cellpadding="30" cellspacing="0" align="center" style="border: 2px solid #F9AF41;">
            <tr>
              <td>
                <center>
                  <img src="img/forgot-password.png" width="30%">
                  <br><br>
                  <h3 class="title" style=" color: #1c1c1c; font-weight: bolder; letter-spacing: normal; text-align: center;">Forgot your password?</h3>
                  <font class="content" style="color: #1c1c1c;">Enter your e-mail address and we'll send you a link to reset your password.</font>
                  <br><br>
                  <input type="email" name="emailforgotpass" placeholder="Enter your email here.">

                  <br><br>
                  <a href="/"><input type="button" name="sendlink" value="CANCEL" style="background-color: transparent; border: 1px solid #1c1c1c; color: #1c1c1c; box-shadow: none"></a>
                  <a href="user-passreset-success"><input onclick="launch_toast()" type="submit" name="sendlinkpass" value="SEND ME AN EMAIL" style="box-shadow: none" required></a>

                    <div id="toast">
                    <div id="img">
                      <img src="img/notif.png" width="25" height="25">
                    </div>
                     <div class="centered">
                    <div id="desc" class="content" style="font-size: 14px;">
                    <font style="color: #AF1D27; font-weight: 500;">Email Sent! Thank you.</font> You'll receive an email shortly to reset your password. <br>If you do not see the email, check your junk mail folder.
                  </div>
                  </div>
                </div>
                </center>

		...
		<div class="collapse navbar-collapse justify-content-end navfont" id="navbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-dark" style="background-color: #902923;">
						<li><a class="dropdown-item" href="about-us" style="font-size: 14px;"><b style="color: #F9AF41; font-weight: 800;"> OUR STORY</b></a></li>
...
<!--start of sec 2-->
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 fs-1 text-center About-bg"  style="background-image: url(img/img-bg.png);"></div>
		</div>
	</div>
<!--end of sec 2-->

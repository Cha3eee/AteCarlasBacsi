...
<head>
	...
	<link href="customercss/Main.css" rel="stylesheet" type="text/css">
...
<div class="container-fluid  py-3" style="background-color: #1c1c1c;">
  <div class="row sticky-top">
    ...
    <div style="color: white;   font-weight: 400;">
      <a class="a content" onclick="on()" style="text-decoration: none; cursor: pointer;"> Login </a> / <a href="user-register" class="a content">Sign Up</a>
    </div>
    </div>
  </div>
</div>
...
<nav class="navbar navbar-expand-md navbar-dark p-2 sticky-top" style="background-color:  #AF1D27; box-shadow: rgba(28, 28, 28, 0.45) 0px 25px 20px -20px;">
	<div class="container-fluid px-5 ps-5">
		...
		<form name="login" id="loginForm" method="POST" action="/user-login/success">
			@csrf
			  <div id="overlay">
				<div class="container1">
					...
					<tr>
					  <td>
						<p align="left">
						  ...
						  <input type="text" required placeholder="Enter your username" name="user_Username" >
						</p>
		  
					  <div class="input-icons">
						<p align="left">
						  <font class="title" style="font-weight: 500; line-height: 2.5; color: #1c1c1c">Password </font>
						  <input type="password" required placeholder="Enter your password" id="id_password" name="user_Password">
				  ...
				  <br>
				 <a href="user-forgetpass" style="text-decoration: none"><font class="content a2">Forgot password?</font><br></a>
				  <font class="content" style="color: #1c1c1c;">Don't have an account? <a href="user-register">Register here</a></font>
				  </div>
				</div>
			  </div>
			</form>
    ...
    <a href="/"><img src="img/logo.png" height="46" class="ps-5"></a>
		...
		<div class="collapse navbar-collapse justify-content-end navfont" id="navbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" href=""><b style="color: #F9AF41; font-weight: 800;"> NEWS</b></a>
					<ul class="dropdown-menu dropdown-menu-dark" style="background-color: #902923;">
						...
						<li><a class="dropdown-item" href="customer-reviews" style="font-size: 14px;"><b style="color: #F9AF41; font-weight: 800;">REVIEWS</b></a></li>
					</ul>
				</li>
...
">
  ...
  <div class="p-4 footerspacing px-5">
    ...
    <a class="pull-left subtitle pt-2" style="text-decoration: none; font-size: 14px;" href="homepagep"> HOME </a>

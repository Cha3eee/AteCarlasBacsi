...
<!-- Login Start -->
<form name="test2.php" method="" action="">
    <div id="overlay">
...
$uniqueID = "CST-" . $randomNumber;
?>
<form name="regform" method="POST" action="{{route('register.submit')}}">
@csrf
                  ...
                  <div class="row jumbotron" style="margin-top: -250px">
                      ...
                      <hr>
                       ...
                       <div class="col-sm-6 form-group">
                          <input type="hidden" class="form-control input2" name="userID" id="name-f" placeholder="Enter your first name *"
                          value="<?php echo $uniqueID?>">
                          <label for="name-f">First Name</label>
                          <input type="text" class="form-control input2" name="user_FirstName" id="name-f" placeholder="Enter your first name *"
                          value="">
                                                   
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="name-l">Last Name</label>
                          <input type="text" class="form-control input2" name="user_LastName" id="name-l" placeholder="Enter your last name *"
                          value="">
                      ...
                      <div class="col-sm-4 form-group">
                          <label for="Date">Date Of Birth</label>
                           <input name = "user_Birthdate" type = "text" 
                            id = "date" required placeholder="Birthdate *" onfocus="(this.type='date')" class="input2" onblur="getAge();" max="2004-06-30" min="1923-01-01" value="">
                      </div>
                      <div class="col-sm-2 form-group">
                          <label for="age">Age</label>
                          <input type="number" class="form-control  input2" name="user_Age" id="u_Age"  maxlength="2" placeholder="Age *" required readonly
                          value="">
                          <br><br>
                      </div>
                      ...
                      <hr>
                       <div class="col-sm-6 form-group">
                          ...
                          <input type="text" class="form-control input2" name="user_Address" id="address" placeholder="Locality/House/Street no. *" required
                          value="">
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="phone">Phone Number</label>
                          <input type="tel" class="form-control input2" name="user_PhoneNum" id="phonenum" placeholder="Enter your number [1234-567-8901]" value="">
                      </div>
                      <div class="col-sm-9 form-group">
                          <label for="email">Email</label>
                          <input type="email" class="form-control input2" name="user_Email" id="email" placeholder="Enter your email address *" required
                          value="">
                      </div>
                      <div class="col-sm-3 form-group">
                        <label for=""></label>
                        <input type="button" class="form-control input2 text-white" name="getCode" id="getCode" value="Get Code" style="width: 100%; padding: 12px; box-shadow: none; background-color: #F9AF41;">
                    </div>
                    <div class="col-sm-3 form-group">
                      <label for="code">Enter Code</label>
                      <input type="text" class="form-control input2" name="user_VCode" id="code" placeholder="Enter code" style="text-align: center" value="">
                      
                      <br><br>
                  </div>
                    <!-- Update the form action for both buttons -->
                    <div class="col-sm-3 form-group">
                        <label for=""></label>
                        <input type="button" class="form-control input2 text-white" name="verify" id="verify" value="Verify" style="width: 100%; padding: 12px; box-shadow: none; background-color: #1c1c1c;">
                    </div>
                      ...
                      <div class="col-sm-12 form-group">
                          ...
                          <input type="tel" name="user_Username" class="form-control input2" id="tel" placeholder="Enter a username (This will be your login username) *" value="">
                      </div>
                      <div class="col-sm-6 form-group">
                        <div class="input-icons">
                          <label for="pass">Password</label>
                          <input type="password" name="user_Password" class="input2" id="password-field" placeholder="Enter your password *">
                      ...
                      <div class="col-sm-6 form-group">
                        <div class="input-icons">
                          ...
                          <input type="password" name="user_Password_confirmation" class="input2" id="password-field" placeholder="Re-enter your password *">
                      ...
                      <div class="col-sm-12 form-group mb-0">
                        <br>
                        <input class="title" type="submit" name="submit" value="CREATE ACCOUNT" style="box-shadow: none" id="createButton">
                        <a href="index.php"><input class="title" type="button" value="CANCEL" style="background-color: transparent; border: 1px solid #1c1c1c; color: #1c1c1c; box-shadow: none;"></a>
                      </div>
...
document.getElementById('verify').addEventListener('click', function () {
    ...
    fetch('{{ route("verify") }}', {
        ...
        body: JSON.stringify({
            user_VCode: document.getElementById('code').value,
        }),
    })
    .then(response => response.json())
    .then(data => {
        ...
        if (data.message) {
            ...
            // Optionally, redirect or perform other actions upon successful verification
            enableCreateAccountButton();
        } else if (data.error) {
            alert(data.error); // Display error message
            // Optionally, update the UI to handle the error
        }
    })
    .catch(error => {
        console.error('Error:', error);
...
<script>
// Disable the Create Account button by default
document.getElementById('createButton').disabled = true;

// Function to enable the Create Account button

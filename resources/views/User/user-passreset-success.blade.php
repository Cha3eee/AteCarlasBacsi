...
<head>
  ...
  <title>Ate Carla's Bacsilog | Reset Successfully</title>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-0 col-xs-0 align-items-center py-5">
          <table border="1" width="50%" cellpadding="30" cellspacing="0" align="center" style="border: 2px solid #F9AF41;">
            <tr>
              <td>
                <center>
                  <img src="img/check-mark.png" width="30%">
                  <br><br>
                  <h3 class="title" style=" color: #1c1c1c; font-weight: bolder; letter-spacing: normal; text-align: center;">Password Changed!</h3>
                  <hr>

                  <br><br>
                  <font class="content" style="color: #1c1c1c; background-color: #F9AF41; padding: 30px 90px; font-size:  14px;">Awesome, you've successfully updated your password.</font>

                  <br><br><br>
                  <p class="content" style="font-size: 13px; color: #1c1c1c;">
                    Now that you have successfully changed your account password, you can now <a class="a content" onclick="on()" style="text-decoration: none; cursor: pointer; color: #0D6EFD;"><b>sign in</b></a>  to start using the website and check if your submitted details are correct or <a href="homepage.php" style="text-decoration: none; cursor: pointer; color: #0D6EFD;">  go back to homepage.</a>
                  </p>
                </div>
                </center>
              </td>

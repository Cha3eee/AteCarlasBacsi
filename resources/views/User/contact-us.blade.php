...
<head>
  ...
  <link rel="icon" href="img/logo.png" type="image/x-icon">
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">
	<link rel="stylesheet" href="customercss/Contact-page-design.css">
...
<!-- Login End -->
    ...
    <div class="collapse navbar-collapse justify-content-end navfont" id="navbar">
      <ul class="navbar-nav">
        ...
        <li class="pe-5">
          <a class="nav-link" href="contact-us"><b style="color: #F9AF41; font-weight: 800;"> CONTACT US</b></a>
        </li>
      </ul>
...
<div class="container-fluid xl mw-100 no-padding" style="background-color: #F1F1F1">
	<div class="row d-flex align-items-center text-center">
		<div class="bgcol5-1 " style="background-image: url(img/contactheader3.png);">

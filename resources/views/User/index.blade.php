@include('UserHeaders.__headerIndex')
...
<!-- Login End -->
    ...
    <button class="navbar-toggler border-0"  type="button" data-bs-toggle="collapse" data-bs-target="#navbar">
		...
		<div class="collapse navbar-collapse justify-content-end navfont" id="navbar">
			<ul class="navbar-nav">
				<li>
					<a class="nav-link" href="homepage"><font style="font-weight: 800;"> HOME </font></a>
				</li>
      ...
      <table border="0" width="90%" cellpadding="20" cellspacing="0" align="center">
        <tr>
          <td>
            ...
            <a href="homepage" class="btn btn-outline-dark title text-white" style=" background-color: #1c1c1c; box-shadow: rgba(0, 0, 0, 0.45) 0px 25px 20px -20px; width: 240px; height: 50px; border-radius: 50px;">
          ...
          $.ajax({
              ...
              success: function(response){
                  if(response.success){
                      ...
                      window.location.href = '/user-ordering-page';
                  } else {
